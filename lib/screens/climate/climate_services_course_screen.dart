...
class ClimateServicesCoursesScreen extends StatefulWidget {
  final String level;
  final List<Map<String, dynamic>> courses;

  const ClimateServicesCoursesScreen({
    super.key,
    required this.level,
  ...
  @override
  State<ClimateServicesCoursesScreen> createState() =>
      _ClimateServicesCoursesScreenState();
}

class _ClimateServicesCoursesScreenState
    extends State<ClimateServicesCoursesScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Climate Services - ${widget.level} Courses"),
